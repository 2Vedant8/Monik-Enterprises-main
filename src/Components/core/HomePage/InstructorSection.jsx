    ...
    <div className='mt-16'>
      <div className='flex flex-col md:flex-row gap-20 items-center'>
        ...
        <div className='md:w-[50%] flex flex-col gap-10'>
            ...
            Mentors from around the world guide millions of students on Monik. We empower you with the tools and skills to mentor in the subjects you're passionate about.
            </p>
