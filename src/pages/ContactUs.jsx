    ...
    <div>
        ...
        <div className='lg:w-[40%]'>
            <div className='flex flex-col gap-6 rounded-xl bg-richblack-800 p-4 lg:p-6'>
                <div className='flex flex-col gap-[2px] p-3 text-sm text-richblack-200'>
                    ...
                    <p className='font-semibold'>monikenterprises01@gmail.com</p>
                </div>
                <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
                    <div className='flex flex-row items-center gap-3'>
                ...
                <p className='font-medium'>Mon - Fri From 8am to 10pm</p>
                <p className='font-semibold'>+91 9569970794</p>
                </div>
            </div>
        </div>
        <div className='lg:w-[60%]'>
            <div className='border border-richblack-600 text-richblack-300 rounded-xl p-7 lg:p-14 flex gap-3 flex-col'>
                ...
                Got an idea? We've got the mentorship. Let's collaborate.
                </h1>
