  ...
  return (
    ...
    <div>
       <div className='min-h-[calc(100vh-3.5rem)] grid place-items-center'>
        ...
        <p className="text-[1.125rem] leading-[1.625rem] my-4 text-richblack-100">A verification code has been sent to you. Enter the code below. Please Check Your SPAM folder.</p>
        <form onSubmit={handleOnSubmit}>
                <OTPInput
                    ...
                    />
                <button type="submit" className="w-full bg-yellow-50 py-[12px] px-[12px] rounded-[8px] mt-6 font-medium text-richblack-900">Verify Your Email</button>
                </form>
